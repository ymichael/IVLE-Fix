$ () ->
        ...
        $modules_grouped = _.groupBy($el_collection, ($el) -> return Math.floor(_.indexOf($el_collection,$el)/2))

        #obj to store our module information
        modules = []

        #breakdown tags into header and links
        _.each($modules_grouped, (module)->
                module_data = {}
        ...
        #parse tags semantically
        parse_links = (link) ->
                console.log('text function declaration')
                #todo
